...
//         <Box as="h3" fontSize="xl" fontWeight="bold"><img style={{width: '50px', borderRadius: "50px", height: "50px"}} src="https://media1.thehungryjpeg.com/thumbs2/ori_3808959_jjkp3tqovfmea5dyqc92e9bu3plxz5zefvmxllx2_monogram-tj-logo-design.jpg" alt="logo"/></Box>
...
//           {currentUser && (
//             <>
//               <h4 style={{ textTransform: "uppercase", fontSize: "16px",  marginLeft:"5rem" }}> Hi!  {currentUser.displayName}</h4>
//               <img style={{ width: '3rem', height: "3rem", borderRadius: '40px' }} src={currentUser.photoURL} alt="" />
//             </>
//           )}
//         </Flex>
